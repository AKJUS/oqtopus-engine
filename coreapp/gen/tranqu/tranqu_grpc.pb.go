...
func (c *transpilerServiceClient) Transpile(ctx context.Context, in *TranspileRequest, opts ...grpc.CallOption) (*TranspileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tranqu_server.proto.v1.TranspilerService/Transpile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTranspilerServiceServer must be embedded to have forward compatible implementations.
...
func _TranspilerService_Transpile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tranqu_server.proto.v1.TranspilerService/Transpile",
	}
