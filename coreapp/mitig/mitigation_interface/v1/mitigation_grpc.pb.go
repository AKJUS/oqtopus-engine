...
type ErrorMitigatorServiceClient interface {
	ReqMitigation(ctx context.Context, in *ReqMitigationRequest, opts ...grpc.CallOption) (*ReqMitigationResponse, error)
}
...
func (c *errorMitigatorServiceClient) ReqMitigation(ctx context.Context, in *ReqMitigationRequest, opts ...grpc.CallOption) (*ReqMitigationResponse, error) {
	out := new(ReqMitigationResponse)
	err := c.cc.Invoke(ctx, "/mitigation_interface.v1.ErrorMitigatorService/ReqMitigation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ErrorMitigatorServiceServer interface {
	ReqMitigation(context.Context, *ReqMitigationRequest) (*ReqMitigationResponse, error)
...
func (UnimplementedErrorMitigatorServiceServer) ReqMitigation(context.Context, *ReqMitigationRequest) (*ReqMitigationResponse, error) {
...
func _ErrorMitigatorService_ReqMitigation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mitigation_interface.v1.ErrorMitigatorService/ReqMitigation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ErrorMitigatorServiceServer).ReqMitigation(ctx, req.(*ReqMitigationRequest))
	}
...
var ErrorMitigatorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mitigation_interface.v1.ErrorMitigatorService",
	...
	Metadata: "mitigation_interface/v1/mitigation.proto",
}
