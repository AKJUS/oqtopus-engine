...
from estimation_interface.v1 import estimator_pb2 as estimation__interface_dot_v1_dot_estimator__pb2
...
def add_EstimationJobServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('estimation_interface.v1.EstimationJobService', rpc_method_handlers)
